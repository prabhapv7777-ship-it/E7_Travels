...
export default function Dashboard({ vehicles, expenses, payments, onNavigate }: DashboardProps) {
  ...
  const vehicleStatusData = [
    ...
    { name: 'Inactive', value: idleVehicles },
  ];
  ...
  const quickNavs = [
    ...
    { name: 'Companies & Sites', route: 'Company Master' },
    { name: 'Vendor Register', route: 'Vendor Register' },
          ...
          <div className="h-80 flex flex-col justify-between items-center">
            ...
            <div className="flex gap-6 justify-center">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-medium text-slate-600">Inactive ({idleVehicles})</span>
              </div>
            </div>
          </div>
        </div>
